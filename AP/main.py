...
class Search(Resource):
    correct_params = {'FumenTypeId': 'int', 'TimeTypeId': 'int', 'DiscordId': 'int',
                      ...
                      'Title': 'str', 'TitleOption': 'int', 'Fumen01': 'str', 'Fume01Option': 'int',
                      'Fumen01Width': 'int',
                      'Fumen01Mirror': 'int'}
    ...
    def param_check(self, params):
        ...
        if not ((params['TitleOption'] == 0 or params['TitleOption'] == 1) and (
                ...
                (params['Fumen01Option'] == 0 or params['Fume01Option'] == 1)):
            return [False, 'Invalid parameter (Caused by "TitleOption", "Fumen01Mirror" or "Fume01Option")']
        # datetimeチェック
        if not ((params[
